...
export const APP_ASSET_VERSION = "2026-05-17-2";
export const APP_PWA_CACHE_VERSION = APP_ASSET_VERSION;
export const APP_INSTALL_ID = "/?app=menlo-codex-v5";

export const APP_ICON_192 = "/menlo-app-icon-192-v20260517b.png";
export const APP_ICON_512 = "/menlo-app-icon-512-v20260517b.png";
export const APP_ICON_MASKABLE = "/menlo-app-icon-maskable-512-v20260517b.png";
export const APP_LOGO_FULL_IMAGE = "/menlo-logo-full-v20260517b.svg";
...
export const APP_LOGO_FULL = APP_LOGO_FULL_IMAGE;
export const APP_LOGO_ICON = `/logo-icon.svg?v=${APP_ASSET_VERSION}`;
export const APP_LOGO_CIRCLE = APP_LOGO_ICON;
export const APP_LOGO_MARK = APP_LOGO_ICON;
