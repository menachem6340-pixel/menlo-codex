...
export const APP_ASSET_VERSION = "2026-05-17-6";
export const APP_PWA_CACHE_VERSION = APP_ASSET_VERSION;
export const APP_INSTALL_ID = "/?app=menlo-codex-v9";

export const APP_ICON_192 = "/logo-icon.png";
export const APP_ICON_512 = "/logo-icon.png";
export const APP_ICON_MASKABLE = "/logo-icon.png";
export const APP_LOGO_FULL_IMAGE = "/logo-full.png";
...
export const APP_LOGO_FULL = `${APP_LOGO_FULL_IMAGE}?v=${APP_ASSET_VERSION}`;
export const APP_LOGO_ICON = `/logo-icon.png?v=${APP_ASSET_VERSION}`;
