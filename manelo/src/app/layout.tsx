...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      { url: "/pwa-install-icon-192.png", sizes: "192x192", type: "image/png" },
      { url: "/pwa-install-icon-512.png", sizes: "512x512", type: "image/png" },
    ...
    apple: [
      ...
      { url: "/pwa-install-icon-maskable-512.png", sizes: "512x512", type: "image/png" },
